...
function myhpUpdater (autoUpdate) {
    var updateURL;
    if(prefUpdateChannel=="release"){updateURL="https://github.com/Habboeasy/userscript/raw/master/habboeasy.user.js";}else if(prefUpdateChannel=="beta"){updateURL="https://github.com/Habboeasy/userscript/raw/master/habboeasy.user.js";}else{updateURL=prefUpdateCustomChannel;}
