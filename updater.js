...
function myhpUpdater (autoUpdate) {
    var updateURL;
    if(prefUpdateChannel=="release"){updateURL="https://github.com/Habboeasy/userscript/";}else if(prefUpdateChannel=="beta"){updateURL="https://github.com/Habboeasy/userscript";}else{updateURL=prefUpdateCustomChannel;}
